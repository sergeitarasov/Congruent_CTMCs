...
# It does not run ance reconstruction to save time.


mod_rayDISC <- function(phy, data, ntraits, r= 1, charnum = 1, rate.mat = NULL,
                             ...
                             diagn = FALSE, do.ans=FALSE, do.thorough=TRUE)
  {
